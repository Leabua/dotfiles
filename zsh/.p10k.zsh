...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_PREFIX_FOREGROUND=4
  typeset -g POWERLEVEL9K_VCS_BACKENDS=(git)
  typeset -g POWERLEVEL9K_VCS_BRANCH_FOREGROUND=9
  typeset -g POWERLEVEL9K_VCS_BRANCH_ICON_FOREGROUND=4
