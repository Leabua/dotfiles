...
// TODO figure out how to attached Escape as a close command for everything. I imagine the way is to focus it first and then press Escape
Scope {
    id: root
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Layout.fillWidth: true
                    spacing: Globals.spacing
                    readonly property int largestButton: Math.max(suspend.contentWidth, logout.contentWidth, reboot.contentWidth, poweroff.contentWidth) + 14
